...
{                                                                         \
  USART1,                       /* USART port                       */    \
  USART_ROUTE_LOCATION_LOC0,  /* USART Tx pin location number     */    \
  USART_ROUTE_LOCATION_LOC0,  /* USART Rx pin location number     */    \
  USART_ROUTE_LOCATION_LOC0, /* USART Clk pin location number    */    \
  USART_ROUTE_LOCATION_LOC0,  /* USART Cs pin location number     */    \
  1000000,                      /* Bitrate                          */    \
  8,                            /* Frame length                     */    \
